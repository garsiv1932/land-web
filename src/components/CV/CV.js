                ...
                <div className="container">
                    ...
                    <div className="justify-content-center mt-5">
                        <article className="row exp justify-content-center">
                            <figure className="col-sm-1 col-lg-1 col-3 text-center">
                                <img src={approved} className="img-fluid img-thumbnail icon"/>
                            </figure>
                            <p className="col-sm-3 col-lg-3 text-center">
                              Marzo de 2020 - a la fecha  
                            </p>
                            <p className="col-sm-3 col-lg-3 text-center">
                                BACK END DEVELOPPER {"\n"} (CHEVACA)
                            </p>
                            <p className="col-sm-5 col-lg-5 text-center">
                        ...
                        <article className="row exp justify-content-center">
                            <figure className="col-sm-1 col-lg-1 col-3">
